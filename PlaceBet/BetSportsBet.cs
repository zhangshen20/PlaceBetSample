...
namespace PlaceBet
{
    class BetSportsBet
    {
        ...
        public BetSportsBet(string accountnubmer, string token, string propositionid, string stake, string odds, string bettype)
        {
            ...
            this.URLAuthenticate = @"https://www.sportsbet.com.au/apigw/auth/realms/sportsbet/protocol/openid-connect/token";
